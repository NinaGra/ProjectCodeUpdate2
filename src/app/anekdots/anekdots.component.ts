...
export class AnekdotComponent implements OnInit {
    ...
    showNextPage(index: any) {
        console.log("indexlength is " + this.indexArray);
        if(index==this.indexArray-1){
            return; 
        }
        this.index = index;
        if (this.index + 10 <= this.indexArray) {
        ...
        console.log("this index " + this.index + ", indexEnde " + this.indexEnd);
        $(".page").remove();
    }
